...
/* 
            ...
            .loginpage-left {
                background-image: url({{ asset('style/dist/img/login-bg.jpg') }});
    ...
    <body class="hold-transition">
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-7 loginpage-left"></div>
                <div class="col-md-5 col-sm-12 loginpage-right">
                    <div class="login-page">
                        <div class="login-logo">
                            <a href="./">
                                <img src="{{ asset('style/dist/img/library-logo.png') }}" class="img-responsive" width="30%">
                            </a>
                        </div>
                        <div class="">
                            <div class="">
